...
const quickPrompts = [
  ...
  },
  {
    icon: BarChart2,
    label: "تقرير الأداء",
    prompt: "أنشئ تقريرًا تحليليًا شاملًا عن أداء الطلاب في الفصل الدراسي الحالي",
  ...
  },
  {
    icon: TrendingUp,
    label: "تنبؤ الأداء",
    prompt: "تنبأ بأداء الطلاب في نهاية الفصل بناءً على البيانات الحالية",
